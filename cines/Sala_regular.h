...
public:
	...
	Sala_regular( string nombre, int edad, string asiento, int precio_pa, string condicion) :Sala( nombre, edad, asiento, precio_pa, condicion)
	{
	}
	...
	void menu_sr()
	{
		...
		do{
			...
			cout << endl;
			cout << "\n  ===========================================" << endl
				<< "\n\t *-------- Compra  de tiquetes Sala Regular --------*" << endl
			...
			case 4:
				...
				cout << endl;
				cout << "<-----Pelicula:   THE AVENGER" << endl;
				Imprimir_sr();
	...
	void menu_srT()
	{
		...
		do{
			...
			case 4:
				...
				cout << "<----------FACTURACION--------------->" << endl;
				cout << endl;
				cout << "<-----Pelicula:   GUERRA MUNDIAL Z" << endl;
				Imprimir_srT();
